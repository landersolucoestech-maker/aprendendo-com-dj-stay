...
expect(client.includes("sessionStorage.getItem"), "Identidade e sequência da aba devem ser restauradas após recarga.");
expect(client.includes("sessionStorage.setItem"), "Cada aba deve persistir identidade e sequência próprias.");
...
expect(externalMedia.includes("event.source !== iframeRef.current?.contentWindow"), "Mensagens externas devem pertencer ao iframe da aula.");
...
expect(externalBridge.includes("PLAYER_ORIGINS"), "Comandos de players externos devem usar origens explícitas.");
