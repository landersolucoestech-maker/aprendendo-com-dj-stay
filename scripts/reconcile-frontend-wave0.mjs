...
function domain(file) {
  ...
  if (/(checkout|payment|payments|hosted-checkout)/i.test(file) && !/^src\/components\/admin\/(CheckoutCronHealthCard|PaymentAnalyticsCard)\.tsx$/.test(file) && file !== "src/hooks/usePaymentAdmin.ts" && file !== "src/integrations/supabase/payment-admin-rpc.ts") return "PAYMENTS";
