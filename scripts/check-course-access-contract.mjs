...
expect(player.includes('sandbox="allow-scripts allow-same-origin allow-presentation"'), "Embed externo deve usar sandbox restritivo.");
expect(player.includes('referrerPolicy="no-referrer"'), "Embed externo não deve enviar referrer.");
