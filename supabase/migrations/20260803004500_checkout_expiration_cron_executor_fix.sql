-- FASE B92: alinhar a autorização da reconciliação ao executor interno do pg_cron.
-- session_user identifica o papel real que abriu a sessão; current_user não é usado
-- porque a função é SECURITY DEFINER e, nesse contexto, representa o proprietário.
