-- Fix PL/pgSQL output-column ambiguity in playback token renewal.
...
begin
  ...
  with revoked as (
    ...
    where playback_tokens.user_id = v_user_id
      and playback_tokens.auth_session_id = v_session_id
      and playback_tokens.lesson_media_id = v_media.id
      and playback_tokens.revoked_at is null
      and playback_tokens.expires_at > statement_timestamp()
